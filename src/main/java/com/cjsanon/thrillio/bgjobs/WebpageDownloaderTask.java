package com.cjsanon.thrillio.bgjobs;

import com.cjsanon.thrillio.dao.BookmarkDao;
import com.cjsanon.thrillio.entities.WebLink;
import com.cjsanon.thrillio.util.HttpConnect;
import com.cjsanon.thrillio.util.IOUtil;
...
public class WebpageDownloaderTask implements Runnable {
    ...
    private static final long TIME_FRAME = 3000000000L; //3 seconds per

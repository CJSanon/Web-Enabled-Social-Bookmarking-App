...
import com.cjsanon.thrillio.entities.Book;
...
public class BookmarkController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(request.getServletPath().contains("save")) {
            ...
            Collection<Bookmark> list = BookmarkManager.getInstance().getBooks(true, 5); //fetch books
            ...
            Collection<Bookmark> list = BookmarkManager.getInstance().getBooks(false, 5); //fetch books
            request.setAttribute("books", list);
        }
